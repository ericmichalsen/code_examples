...
for site in sites:
    ...
    print("terminus pc " + site[1] + ".dev --app=mysql < " + site[1] + ".sql") # Pancakes Plugin Required
    print("terminus wp " + site[1] + ".dev search-replace " + site[6] + " '/'")
    print("terminus rsync ./" + site[1] + "/<CONTENT>/. " + site[1] + ".dev:code/wp-content") # Rsync Plugin Required
